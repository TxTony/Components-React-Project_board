...
export const AddItemRow: React.FC<AddItemRowProps> = ({
  ...
  // Calculate colspan: all visible fields + drag handle column + row number column + checkbox column if present
  const colspan = visibleFields.length + 2 + (showSelection ? 1 : 0);
