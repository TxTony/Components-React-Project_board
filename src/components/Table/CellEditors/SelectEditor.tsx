...
export const SelectEditor: React.FC<SelectEditorProps> = ({
  ...
  return (
    <div
      ref={dropdownRef}
      className="gitboard-table__select-dropdown fixed bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md shadow-lg py-1 min-w-[200px] max-h-[300px] overflow-y-auto z-50"
