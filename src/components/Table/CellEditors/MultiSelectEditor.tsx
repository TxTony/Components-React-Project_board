...
export const MultiSelectEditor: React.FC<MultiSelectEditorProps> = ({
  ...
  return (
    <div
      ref={dropdownRef}
      className="gitboard-table__multiselect-dropdown fixed bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md shadow-lg min-w-[200px] z-50"
